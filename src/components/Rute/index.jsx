...
export default function Rute() {
    ...
    const byTransjakarta = () => {
        return (
            <div className="bg-[#EBEBEB] py-5 px-5">
                <img src="./assets/TransJakarta.png" alt="" className="" />
                <img src="./assets/Blok M.png" alt="" className=""/>
                <img src="./assets/Pulo Gadung.png" alt="" className=""/>
            </div>
        )
    }
    ...
    const byTrain = () => {
        return (
            <div className="bg-[#EBEBEB] py-5 px-5">
                <img src="./assets/Manggarai.png" alt="" className="" />
                <img src="./assets/Bogor.png" alt="" className=""/>
                <img src="./assets/Bekasi.png" alt="" className=""/>
            </div>
        )
    }
    ...
    return (
        <>
            <div className="flex justify-evenly items-center font-newScience font-medium text-sm border-y border-3 border-[#2B2225] bg-[#8A966D]">
