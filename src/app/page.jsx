  ...
  return (
    <>
      ...
      <div className="">
        ...
        <section id="section1">
          <div className="relative grid grid-cols-2 pt-20">
            <div className="flex flex-wrap justify-center items-center pt-12 pb-24 bg-[#203731]">
              <div className="px-12">
                <h1 className="font-newScience font-new-science font-bold text-5xl text-[#CBBA9D]">
        ...
        {/* About */}
        <div className="bg-[#EBEBEB] pt-10 pb-32">
        ...
        {/* whos there */}
        <section id="section3" className="relative pt-20 bg-[#EBEBEB]">
          <div className=" flex flex-row-reverse border-2 border-[#2B2225] bg-[#4C6444]">
            <div className="absolute -top-7 left-7 max-w-4xl">
        ...
        {/* Getting Here */}
        <section id="section4" className="pt-16 bg-[#EBEBEB]">
